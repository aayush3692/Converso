...
const Companion = ({ companionId, subject, topic
            ...
            <section className='flex gap-8 max-sm:flex-col'>
                ...
                <div className='user-section'>
                    <div className='user-avatar'>
                        ...
                        <button className={
                            cn('rounded-lg cursor-pointer py-2 transition-colors w-full text-white',
                                callStatus === CallStatus.ACTIVE ? 'bg-red-500 hover:bg-red-600'
                                    : 'bg-primary', callStatus === CallStatus.CONNECTING && 'animate-pulse'
